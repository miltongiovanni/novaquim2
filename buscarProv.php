...
<table border="0" align="center" width="700">
    ...
    <tr>
    	<td>
		<form id="form1" name="form1" method="post" action="updateProvForm.php">
        
      	<div align="center"><strong>Proveedor: </strong><input type="text" id="bus" name="bus" onkeyup="loadXMLDoc()" required /><div id="myDiv"></div>
        <br>
