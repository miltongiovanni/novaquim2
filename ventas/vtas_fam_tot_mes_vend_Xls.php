...
from det_factura, factura, prodpre, clientes where Factura=Id_fact and  fechaFactura>='$FchIni' and fechaFactura<='$FchFin' and Cod_prese=Cod_producto and month(fechaFactura)=$b and Cod_ant=$codigo_ant and Nit_cliente=nitCliente and codVendedor=$vendedor;";
