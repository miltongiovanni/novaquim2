...
$objPHPExcel->setActiveSheetIndex(0)
            ...
            ->setCellValue('B1', iconv("iso-8859-1", "UTF-8",'Código'))
...
where Factura=Id_fact and Cod_producto=Cod_prese and Fech_fact>='$FchIni' and Fech_fact<'$FchFin' group BY Cod_producto;";
