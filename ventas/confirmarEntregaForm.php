...
<div id="contenedor" class="container-fluid">
    ...
    <form method="post" action="updateEntregaPedido.php" name="form1">
        <div class="form-group row">
            <label class="col-form-label col-1 text-end" for="fechaEntrega"><strong>Pedido: </strong></label>
            <input type="text" class="form-control col-2" name="idPedido" id="idPedido" value="<?=$idPedido?>" readonly>
        </div>
        <div class="form-group row">
            <label class="col-form-label col-1 text-end" for="fechaEntrega"><strong>Fecha entrega: </strong></label>
