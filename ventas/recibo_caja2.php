...
<form method="post" action="recibo_caja2.php" name="form1">
  <table border="0"  align="center" width="80%" >
    ...
    <tr>
      ...
      <td><div align="left"><?php echo '$ <script type="text/javascript"> document.write(commaSplit('.$row['Total_R'].'))</script>' ;?></div></td>
    </tr>
        <?php
	...
	echo '<tr>
      ...
      <td colspan="2">$ <script type="text/javascript"> document.write(commaSplit('.$reteica.'))</script> </td>
