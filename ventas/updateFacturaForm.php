...
<div id="saludo1"><strong>FACTURA DE VENTA</strong></div>
    <form method="post" action="updateFactura.php" name="form1">
        ...
        <div class="form-group row">
            ...
            <input type="text" class="form-control col-5" name="idFactura" value="<?=$factura['idFactura']?>" id="idFactura" readonly required>
        </div>
        <div class="form-group row">
            ...
            <input type="text" class="form-control col-5" name="nomCliente" value="<?=$factura['nomCliente']?>" id="nomCliente" readonly>
        </div>
        <div class="form-group row">
            <label class="col-form-label col-2 text-right" for="fechaFactura"><strong>Fecha de Venta</strong></label>
            <input type="date" class="form-control col-5" name="fechaFactura" value="<?=$factura['fechaFactura']?>" id="fechaFactura" required>
        </div>
        <div class="form-group row">
            <label class="col-form-label col-2 text-right" for="fechaVenc"><strong>Fecha de Vencimiento</strong></label>
            <input type="date" class="form-control col-5" name="fechaVenc" value="<?=$factura['fechaVenc']?>" id="fechaVenc" required>
        </div>
        <div class="form-group row">
            ...
            <input type="text" class="form-control col-5" name="vendedor" value="<?=$factura['vendedor']?>" id="vendedor" readonly>
        </div>
        <div class="form-group row">
            <label class="col-form-label col-2"><strong>Precio</strong></label>
            <div class="col-form-label col-5 ">
                <input name="tipPrecio" type="radio" id="precio_0" value="1" <?=$factura['tipPrecio']==1? 'checked': '' ?>>
                <label for="precio_0">Fábrica</label>
                <input type="radio" name="tipPrecio" value="2" id="precio_1" <?=$factura['tipPrecio']==2? 'checked': '' ?>>
                <label for="precio_1">Distribuidor</label>
                <input type="radio" name="tipPrecio" value="3" id="precio_2" <?=$factura['tipPrecio']==3? 'checked': '' ?>>
                <label for="precio_2">Detal</label>
                <input type="radio" name="tipPrecio" value="4" id="precio_3" <?=$factura['tipPrecio']==4? 'checked': '' ?>>
                <label for="precio_3">Mayorista</label>
                <input type="radio" name="tipPrecio" value="5" id="precio_4" <?=$factura['tipPrecio']==5? 'checked': '' ?>>
        ...
        <div class="form-group row">
            ...
            <input type="text" class="form-control col-5" onKeyPress="return aceptaNum(event)" name="ordenCompra" value="<?=$factura['ordenCompra']?>" id="ordenCompra">
        </div>
        <div class="form-group row">
            <label class="col-form-label col-2 text-right" for="descuento"><strong>Descuento</strong></label>
            <input type="text" class="form-control col-5" onKeyPress="return aceptaNum(event)" name="descuento" value="<?=$factura['descuento']*100?>" id="descuento">
        </div>
        <div class="form-group row">
