...
$pdf->SetFont('Arial','B',12);
$pdf->Cell(25,4,utf8_decode('Rutero No. '),0 , 0, 'R');
$pdf->SetFont('Arial','',12);
$pdf->Cell(15,4,$idRutero,0,0);
$pdf->SetFont('Arial','B',12);
$pdf->Cell(25,4,utf8_decode('FECHA:'),0 , 0, 'R');
$pdf->SetFont('Arial','',12);
...
$pdf->Cell(12,3.5,utf8_decode('Rem'), 1,0,'C');
$pdf->Cell(50,3.5,'Cliente', 1,0,'C');
$pdf->Cell(50,3.5,utf8_decode('Dirección de entrega'), 1,0,'C');
$pdf->Cell(30,3.5,utf8_decode('Recibido por'), 1,0,'C');
$pdf->Cell(50,3.5,utf8_decode('Firma y sello'), 1,0,'C');
$pdf->Cell(40,3.5,utf8_decode('Observaciones'), 1,0,'C');
$pdf->SetFont('Arial','',8);
$pdf->Ln(3.5);
for($i=0; $i<count($pedidosRutero); $i++)
{
	...
	$pdf->Cell(12,5,utf8_decode($pedidosRutero[$i]['idRemision']), 'LR',0,'L');
	$pdf->Cell(50,5,utf8_decode($pedidosRutero[$i]['nomCliente']), 'LR',0,'L');
	$pdf->Cell(50,5,utf8_decode($pedidosRutero[$i]['dirSucursal']), 'LR',0,'L');
	...
	$pdf->Cell(50,5,utf8_decode($pedidosRutero[$i]['nomSucursal']), 'LR',0,'L');
