...
where Nit_cliente=clientes.Nit_clien and clientes_sucursal.Nit_clien=clientes.Nit_clien and tip_precio=Id_precio and Id_sucurs=Id_sucursal and Id_cat_clien=13 and cod_vend=Id_personal  AND pedido.Estado='A' order by Id_pedido DESC;";
