...
where Nit_cliente=clientes.nitCliente and clientes_sucursal.Nit_clien=clientes.nitCliente and tipoPrecio=Id_precio and idSucursal=idSucursal and idCatCliente=13 and codVendedor=Id_personal  AND pedido.Estado='A' order by idPedido DESC;";
