...
<html lang="es">
<head>
<title>Lista de Órdenes de Pedido Anuladas</title>
<meta charset="utf-8">
...
<body>
<div id="contenedor">
<div id="saludo1"><strong>LISTA DE ÓRDENES DE PEDIDO DE VENTA DIRECTA ANULADAS</strong></div> 
...
<tr>
    ...
    <th width="140" class="formatoEncabezados">Directora de Zona</th>
...
where Nit_cliente=clientes.nitCliente and clientes_sucursal.Nit_clien=clientes.nitCliente and tipoPrecio=Id_precio and idSucursal=Id_sucursal and idCatCliente=13 and codVendedor=Id_personal  AND pedido.Estado='A' order by idPedido DESC;";
