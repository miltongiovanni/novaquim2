...
from r_caja, factura, clientes, form_pago where Fact=Factura and Nit_cliente=nitCliente and form_pago=idFormaPago order by Id DESC limit " . $inicio . "," . $TAMANO_PAGINA;
