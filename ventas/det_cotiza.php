...
self.location="' . $ruta . '"
    ...
    $link = conectarServidor();
    $qryb = "select idCotizacion, nomCliente, fechaCotizacion, precioCotizacion, presentaciones, distribucion, productos, nom_personal from cotizaciones, clientes_cotiz, personal where idCotizacion=$num_cotiza and idCliente=idCliente and Id_personal=codVendedor;";
    ...
    <table align="center" width="68%">
        ...
        <tr>
            ...
            <td width="47%" colspan="1">
                <div align="center">
                    <form id="form1" name="form1" method="post" action="UpdateCotform.php"><input name="cotiza"
                                                                                                  type="hidden"
                                                                                                  value="<?php echo $num_cotiza; ?>"><input
                                name="button" type="submit" onClick="return Enviar(this.form);" value="Modificar">
                    </form>
                </div>
            </td>
            <td width="30%">
    ...
    <div align="center"><input name="" type="button" class="resaltado" onClick="window.location='menu.php'"
                               value="Ir a Menú"></div>
</div>
</body>
</html>
