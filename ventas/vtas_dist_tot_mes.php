...
<body>
<div id="contenedor">
<div id="saludo1"><strong>CONSULTA DE VENTAS POR FAMILIA DE PRODUCTOS DISTRIBUIDOS POR MES</strong></div> 
...
<table width="100%"  align="center" border="0">
  <tr> 
      <form action="vtas_dist_tot_mes_Xls.php" method="post" target="_blank"><td width="91%" align="right"><input name="Submit" type="submit" class="resaltado" value="Exportar a Excel"></td><input name="FchIni" type="hidden" value="<?php echo $FchIni ?>"><input name="FchFin" type="hidden" value="<?php echo $FchFin ?>"></form>
...
from det_factura, factura, distribucion, cat_dist  where idFactura=idFactura and  fechaFactura>='$FchIni' and fechaFactura<='$FchFin' and Id_distribucion=codProducto and distribucion.Id_Cat_dist=cat_dist.Id_Cat_dist and month(fechaFactura)=$b and cat_dist.Id_cat_dist=$Id_cat_dist";
//echo $sqlv."<br>";
