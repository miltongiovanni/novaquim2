...
<div id="contenedor">
    ...
    <form method="post" action="update_cotiza.php" name="form1">
        ...
        <div class="form-group row">
            ...
            <input type="date" class="form-control col-4" name="fechaCotizacion" id="fechaCotizacion" value="<?= $cotizacion['fechaCotizacion'] ?>" required>
        </div>
        <div class="form-group row">
            <label class="col-form-label col-2"><strong>Destino</strong></label>
            <div class="col-form-label col-4 ">
                <input name="destino" type="radio" id="Destino_0" value="1" <?php if($cotizacion['destino']==1 ) echo 'checked'; ?>>
                <label for="Destino_0">Impresión</label>
                <input type="radio" name="destino" value="2" id="Destino_1" <?php if($cotizacion['destino']==2 ) echo 'checked'; ?>>
        ...
        <div class="form-group row">
            ...
            <div class="col-form-label col-4 ">
                <input name="presentaciones" type="radio" id="Presentaciones_0" value="1" <?php if($cotizacion['presentaciones']==1 ) echo 'checked'; ?>>
                <label for="Presentaciones_0">Todas</label>
                <input type="radio" name="presentaciones" value="2" id="Presentaciones_1" <?php if($cotizacion['presentaciones']==2 ) echo 'checked'; ?>>
                <label for="Presentaciones_1">Pequeñas</label>
                <input type="radio" name="presentaciones" value="3" id="Presentaciones_2" <?php if($cotizacion['presentaciones']==3 ) echo 'checked'; ?>>
        ...
        <div class="form-group row">
            ...
            <div class="col-form-label col-4 ">
                <input name="precio" type="radio" id="precio_0" value="1" <?php if($cotizacion['precioCotizacion']==1 ) echo 'checked'; ?>>
                <label for="precio_0">Fábrica</label>
                <input type="radio" name="precio" value="2" id="precio_1" <?php if($cotizacion['precioCotizacion']==2 ) echo 'checked'; ?>>
                <label for="precio_1">Distribuidor</label>
                <input type="radio" name="precio" value="3" id="precio_2" <?php if($cotizacion['precioCotizacion']==3 ) echo 'checked'; ?>>
                <label for="precio_2">Detal</label>
                <input type="radio" name="precio" value="4" id="precio_3" <?php if($cotizacion['precioCotizacion']==4 ) echo 'checked'; ?>>
                <label for="precio_3">Mayorista</label>
                <input type="radio" name="precio" value="5" id="precio_4" <?php if($cotizacion['precioCotizacion']==5 ) echo 'checked'; ?>>
