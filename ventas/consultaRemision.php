...
<html lang="es">
<head>
    <title>Consulta de Ventas por Remisi&oacute;n</title>
    <meta charset="utf-8">
...
<body> 
<div id="contenedor">
<div id="saludo"><strong>CONSULTA DE VENTAS POR REMISI&Oacute;N</strong></div> 
<form method="post" action="listarConsRemision.php" name="form1">	
	<table align="center">
    <tr>
      	<td>&nbsp;</td>
      	<td>&nbsp;</td>
