...
<div id="contenedor">
    ...
    <form method="post" action="updatePedido.php" name="form1">
        <div class="form-group row">
            ...
            <input type="text" class="form-control col-5" name="idPedido" value="<?=$pedido['idPedido']?>" id="idPedido" readonly required>
        </div>
        <div class="form-group row">
            ...
            <input type="text" class="form-control col-5" name="estadoPedido" value="<?=$pedido['estadoPedido']?>" id="estadoPedido" readonly>
        </div>
        <div class="form-group row">
            ...
            <div class="col-4 px-0" id="myDiv">
                ...
                <input type="text" name="nomCliente" id="nomCliente" class="form-control" value="<?=$pedido['nomCliente']?>" readOnly>
            </div>
        </div>
        <div class="form-group row">
        ...
        <div class="form-group row">
            <label class="col-form-label col-2 text-right" for="fechaPedido"><strong>Fecha de
                    Pedido</strong></label>
            <input type="date" class="form-control col-5" name="fechaPedido" value="<?=$pedido['fechaPedido']?>" id="fechaPedido" required>
        </div>
        <div class="form-group row">
            <label class="col-form-label col-2 text-right" for="fechaEntrega"><strong>Fecha de
                    entrega</strong></label>
            <input type="date" class="form-control col-5" name="fechaEntrega" value="<?=$pedido['fechaEntrega']?>" id="fechaEntrega" required>
        </div>
        <div class="form-group row">
