...
<div id="contenedor" class="container-fluid">
    <div id="saludo1">
        <img src="../../../images/LogoNova.jpg" alt="novaquim" class="img-fluid mb-2"><h4>CONSULTA <?= $type == 1 ? 'UNIDADES' : 'VALOR' ?> POR VENTAS POR FAMILIA DE PRODUCTOS
    ...
    <script>
        ...
        $.ajax({
            ...
            type: 'POST',
            data: {
                "action": 'prodDistCantTotalYearVend',
                "year": year,
                "type": type,
                    ...
                    "data": {
                        ...
                        "datasets": [{
                            ...
                            "backgroundColor": ["rgba(86,168,255, 0.5)", "rgba(122,255,228, 0.5)", "rgba(202,114,255,0.5)", "rgba(87,241,120, 0.5)",
                                "rgba(255,127,80, 0.5)", "rgba(255,215,0,0.5)", "rgba(224,116,156,0.5)", "rgba(224,116,156,0.5)",
