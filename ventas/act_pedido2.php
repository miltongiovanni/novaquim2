...
<?php
	...
	$result11=mysqli_query($link,"update pedido set Nit_cliente='$Nit_cliente' where Id_pedido=$pedido");
	
	$qry22="select Id_pedido, Nit_cliente, Fech_pedido, Fech_entrega, tip_precio, Estado, Id_sucurs, tipo_precio, Nom_sucursal from pedido, tip_precio, clientes_sucursal where tip_precio=Id_precio and Nit_cliente=Nit_clien and Id_sucurs=Id_sucursal and Id_pedido=$pedido";
...
<form method="post" action="det_pedido.php" name="form1">	
    ...
    <tr>
		...
		<?php
			...
			$result1=mysqli_query($link, "select Id_sucursal, Nom_sucursal from pedido, clientes, clientes_sucursal WHERE Nit_cliente=clientes.Nit_clien and clientes.Nit_clien=clientes_sucursal.Nit_clien and Id_sucurs=Id_sucursal and  Id_pedido=$pedido;");
