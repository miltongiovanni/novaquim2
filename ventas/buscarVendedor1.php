...
<div id="saludo"><strong>SELECCIONAR VENDEDOR A CONSULTAR</strong></div> 
<table width="100%" border="0">
  	<tr>
    	<td>
		<form id="form1" name="form1" method="post" action="listarPedidoVend.php">
      	<div align="center"><strong>Vendedor:</strong>
      	  <?php	
