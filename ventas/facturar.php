...
<div id="contenedor">
    ...
    <table border="0" align="center">
        <form id="form1" name="form1" method="post" action="hfactura.php">
            ...
            <tr>
                <td width="119">
                    <div align="right"><strong>No. de Pedido&nbsp;</strong></div>
                </td>
            ...
            <tr>
                <td>
                    <div align="right"><input type="reset" value="Restablecer"></div>
                </td>
                <td>
                    <div align="left"><input type="button" value="  Continuar " onclick="return Enviar(this.form);">
                    </div>
                </td>
            </tr>
        </form>
