...
<div id="contenedor" class="container-fluid">
    ...
    <form method="post" action="updateFactura.php" name="form1">
        ...
        <div class="mb-3 row">
            <label class="form-label col-2 text-end" for="nomCliente"><strong>Cliente</strong></label>
        ...
        <div class="mb-3 row">
            <label class="form-label col-2 text-end" for="fechaFactura"><strong>Fecha de Venta</strong></label>
            <input type="date" class="form-control col-5" name="fechaFactura" value="<?= $factura['fechaFactura'] ?>"
                   id="fechaFactura" required>
        </div>
        <div class="mb-3 row">
            <label class="form-label col-2 text-end" for="fechaVenc"><strong>Fecha de Vencimiento</strong></label>
            <input type="date" class="form-control col-5" name="fechaVenc" value="<?= $factura['fechaVenc'] ?>"
                   id="fechaVenc" required>
        </div>
        <div class="mb-3 row">
            <label class="form-label col-2 text-end" for="vendedor"><strong>Vendedor</strong></label>
        ...
        <div class="mb-3 row">
            <label class="form-label col-2 text-end" for="ordenCompra"><strong>Orden de Compra</strong></label>
        ...
        <div class="mb-3 row">
            <label class="form-label col-2 text-end" for="descuento"><strong>Descuento</strong></label>
        ...
        <div class="mb-3 row">
            <label class="col-2 text-end form-label" for="observaciones"><strong>Observaciones</strong></label>
