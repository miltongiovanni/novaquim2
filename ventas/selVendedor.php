...
<div id="contenedor" class="container-fluid">
    ...
    <form method="post" action="comis_vend.php" name="form1">
        ...
        <div class="mb-3 row">
            <label class="form-label col-1 text-end" for="fechaInicial"><strong>Fecha inicial</strong></label>
            <input type="date" class="form-control col-2" name="fechaInicial" id="fechaInicial" required>
        </div>
        <div class="mb-3 row">
            <label class="form-label col-1 text-end" for="fechaFinal"><strong>Fecha final</strong></label>
