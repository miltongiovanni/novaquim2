...
$sql="	SELECT inv_prod.codPresentacion as Codigo, Nombre, sum(inv_prod) as inventario, stock_prese 
FROM inv_prod, prodpre, productos, medida
where inv_prod.codPresentacion=prodpre.Cod_prese AND medida.Id_medida=prodpre.Cod_umedid and productos.Cod_produc=prodpre.Cod_produc 
