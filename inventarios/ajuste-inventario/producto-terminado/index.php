...
<div id="contenedor" class="container-fluid">
    ...
    <form id="form1" name="form1" class="formatoDatos5" method="post" action="updateInvProd.php">
        ...
        <div class="mb-3 row">
            <div class="col-3">
                <label class="form-label" for="codPresentacion"><strong>Producto</strong></label>
            ...
            <div class="col-1">
                ...
                <select name="loteProd" id="loteProd" class="form-select"
                        onchange="getInvPresentacionXLote(document.getElementById('codPresentacion').value, this.value)"
                        required>
                </select>
            </div>
            <div class="col-1">
                <label class="form-label" for=invProd><strong>Inventario</strong></label>
                <input type="text" class="form-control" name="invProd" id="invProd" onkeydown="return aceptaNum(event)">
            </div>
        </div>
        <div class="mb-3 row">
            <div class="col-5">
