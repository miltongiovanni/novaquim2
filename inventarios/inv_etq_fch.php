...
<div id="contenedor" class="container-fluid">
    <div id="saludo1">
        <img src="../images/LogoNova.jpg" alt="novaquim" class="img-fluid mb-2"><h4>INVENTARIO DE ETIQUETAS A <?= $fecha; ?></h4></div>
    <div class="row flex-end">
        <div class="col-2">
            <form action="XlsInvEtqFecha.php" method="post" target="_blank">
