...
foreach ($invMPrimas as $invMPrima)
{
	...
	$spreadsheet->getActiveSheet()->setCellValue([3, $j], $invMPrima['loteMP']);
	$spreadsheet->getActiveSheet()->setCellValue([4, $j], $invMPrima['invMP']);
	$spreadsheet->getActiveSheet()->setCellValue([5, $j++], $invMPrima['precioMPrima']);
}
