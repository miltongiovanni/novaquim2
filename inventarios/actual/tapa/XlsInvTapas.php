...
// Rename sheet
$spreadsheet->getActiveSheet()->setTitle('Inventario Tapas');

$invTapasOperador = new InvTapasOperaciones();
$invTapas = $invTapasOperador->getTableDetalleInvTapas();
...
header('Content-Disposition: attachment;filename="Inv_tapas.xlsx"');
