...
// Rename sheet
$spreadsheet->getActiveSheet()->setTitle('Inventario Etiquetas');

$invEtiquetasOperador = new InvEtiquetasOperaciones();
$invEtiquetas = $invEtiquetasOperador->getTableDetalleInvEtiqueta();
...
foreach ($invEtiquetas as $invEtiqueta)
{
	...
	$spreadsheet->getActiveSheet()->setCellValueByColumnAndRow(4, $j++, $invEtiqueta['precEtiqueta']);
}
// Set active sheet index to the first sheet, so Excel opens this as the first sheet
$spreadsheet->setActiveSheetIndex(0);
// Redirect output to a client’s web browser (Xlsx)
header('Content-Type: application/vnd.openxmlformats-officedocument.spreadsheetml.sheet');
header('Content-Disposition: attachment;filename="Inv_etiquetas.xlsx"');
