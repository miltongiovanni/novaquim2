...
<?php
	...
	$qry="delete from cat_prov  where Id_cat_prov=$IdCat;";
	...
	if($result)
	{
		...
		mover_pag($ruta,"Tipo de Proveedor Eliminado Correctamente");
	}
	else
	{	
		$ruta="deleteCatForm_DIS.php";
		mover_pag($ruta,"No se pudo eliminar el Tipo de Proveedor");
	}
	mysql_close($link);
