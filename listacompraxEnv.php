...
from compras, det_compras, proveedores where compras.Id_compra=det_compras.Id_compra and compra=2 and Codigo=$IdEnvTap and nit_prov=NIT_provee order by Fech_comp desc";
