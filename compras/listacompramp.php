...
WHERE compras.nit_prov=proveedores.NIT_provee and compra=1 and estado=Id_estado
...
while($row=mysqli_fetch_array($rs, MYSQLI_BOTH))
{
	...
	<td class="formatoDatos"><div align="right">$ <script language="javascript"> document.write(commaSplit('.$row['retencion'].'))</script></div></td>
	<td class="formatoDatos"><div align="right">$ <script language="javascript"> document.write(commaSplit('.$row['ret_ica'].'))</script></div></td>
	<td class="formatoDatos"><div align="right">$ <script language="javascript"> document.write(commaSplit('.($row['Total']-$row['retencion']-$row['ret_ica']).'))</script></div></td>
	';
