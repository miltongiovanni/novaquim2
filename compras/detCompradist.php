...
<form method="post" action="detCompradist.php" name="form1">
  <table border="0"  align="center" summary="encabezado" width="74%" cellpadding="0" >
    ...
    <tr>
      ...
      <td colspan="2"><div align="left"><?php echo '$ <script  type="text/javascript"> document.write(commaSplit('.$row['total_fact'].'))</script>' ;?> </div></td>
    </tr>
    <tr>
    <td width="28%" colspan="1"><div align="right"><strong>NIT</strong></div></td>
      ...
      <td colspan="2"><div align="left"><?php echo '$ <script  type="text/javascript"> document.write(commaSplit('.$row['ret_ica'].'))</script>' ;?> </div></td>
     </tr>
    <tr>
      ...
      <td colspan="2"><div align="left"><?php echo '$ <script  type="text/javascript"> document.write(commaSplit('.$row['retencion'].'))</script>' ;?> </div></td>
    </tr>
    <tr>
      ...
      <td colspan="2"><div align="left"><?php echo '$ <script  type="text/javascript"> document.write(commaSplit('.($row['total_fact']-$row['retencion']-$row['ret_ica']).'))</script>' ;?> </div></td>
    </tr>
    <tr>
      <td colspan="7">&nbsp;</td>
    </tr>
      ...
      <td colspan="7"><hr></td>
          ...
          <?php
			...
			echo '</td><td><div align="center">'.$row['Codigo'].'</div></td>
			  ...
			  <td><div align="center">$ <script  type="text/javascript"> document.write(commaSplit('.$row['Precio'].'))</script></div></td><td>';
			  if ($estadoc!=7)
				{
