...
<table width="711" border="0" align="center">
  <tr> <form action="PagosXComprasProv_Xls.php" method="post" target="_blank"><input name="prov" type="hidden" value="<?php echo $prov; ?>"><input name="nprov" type="hidden" value="<?php echo $rowbus['Nom_provee']; ?>"><td width="611" align="right"><input name="Submit" type="submit" class="resaltado" value="Exportar a Excel">
    </td></form>
