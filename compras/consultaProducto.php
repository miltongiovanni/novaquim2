...
<html>
<head>
    <title>Consulta de Ventas por Referencia de Producto</title>
    <meta charset="utf-8">
...
<body> 
<div id="contenedor">
<div id="saludo"><strong>CONSULTA DE VENTAS POR REFERENCIA DE PRODUCTO</strong></div> 
<form method="post" action="listarConsProducto.php" name="form1">	
  	<table align="center">
    <tr>
      	<td>&nbsp;</td>
      	<td>&nbsp;</td>
