...
<tr>
  ...
  <tr>
    ...
    <td><?php
		  ...
		  $result1=mysqli_query($link,"select NIT_provee, Nom_provee, Num_fact, Fech_comp, Fech_venc from proveedores, compras where Id_cat_prov=2 and Id_compra=$Factura and NIT_provee=nit_prov;");
  ...
  <tr>
    ...
    <td><input type="text" name="num_fac" size=36 onKeyPress="return aceptaNum(event)" value="<?php echo $row1['Num_fact']; ?>"></td>
  </tr>
  <tr>
    <td align="right"><strong>Fecha de Compra</strong></td>
    <td><input type="text" name="FchFactura" id="sel2" readonly size=31 value="<?php echo $row1['Fech_comp']; ?>"><input type="reset" value=" ... "
      onclick="return showCalendar('sel2', '%Y-%m-%d', '12', true);"></td>
  </tr>
  <tr>
    <td align="right" ><strong>Fecha Vencimiento</strong></td>
      <td><input type="text" name="VenFactura" id="sel1"  readonly size=31 value="<?php echo $row1['Fech_venc']; ?>"><input type="reset" value=" ... "
