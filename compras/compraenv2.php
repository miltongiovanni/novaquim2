...
<tr>
  ...
  <tr>
    ...
    <td><?php
		  ...
		  $result1=mysqli_query($link,"select nitProv, Nom_provee, Num_fact, Fech_comp, Fech_venc from proveedores, compras where Id_cat_prov=2 and Id_compra=$Factura and nitProv=nit_prov;");
