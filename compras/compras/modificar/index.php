...
<div id="contenedor" class="container-fluid">
    ...
    <form id="form1" name="form1" method="post" action="../../compras/modificar/updateCompraForm.php">
        <div class="mb-3 row">
            <div class="col-2">
                <label class="form-label" for="idCompra"><strong>No. de compra</strong></label>
