...
<body>
<div id="contenedor">
<div id="saludo1"><strong>HIST&Oacute;RICO DE COMPROBANTE DE EGRESO</strong></div>
<table border="0" cellspacing="0" cellpadding="0" align="center" summary="encabezado" width="100%">
  <tr> 
  <td width="93%" align="right"><form action="fech_histo_pagos_Xls.php" method="post" ><input name="Submit" type="submit" class="resaltado" value="Exportar a Excel"></form></td>
  <td width="7%"><div align="right"><input type="button" class="resaltado" onClick="window.location='menu.php'" value="Ir al Men&uacute;"></div></td>
  </tr>
</table>
