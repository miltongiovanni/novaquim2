...
<form method="post" action="detCompramp.php" name="form1">	
    ...
    <tr>
      ...
      <td><?php
			...
			$result=mysqli_query($link,"select * from proveedores where Id_cat_prov=1 order by Nom_provee");
    ...
    <tr>
      ...
      <td><input type="text" name="FchFactura" id="sel2" readonly size=36><input type="reset" value=" ... "
		onclick="return showCalendar('sel2', '%Y-%m-%d', '12', true);"></td>
    </tr>
    <tr>
   	  <td align="right" ><strong>Fecha Vencimiento</strong></td>
        <td><input type="text" name="VenFactura" id="sel1"  readonly size=36><input type="reset" value=" ... "
