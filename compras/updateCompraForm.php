...
<div id="contenedor">
    ...
    <form name="form2" method="POST" action="updateCompra.php">
        ...
        <div class="form-group row">
            ...
            <input type="text" class="form-control col-2" name="idCompra" id="idCompra" value="<?=$compra['idCompra']?>" readonly>
        </div>
        <div class="form-group row">
        ...
        <div class="form-group row">
            ...
            <input type="text" class="form-control col-2" name="numFact" id="numFact" value="<?=$compra['numFact']?>" onKeyPress="return aceptaNum(event)">
        </div>
        <div class="form-group row">
            <label class="col-form-label col-2 text-right"  for="fechComp"><strong>Fecha de compra</strong></label>
            <input type="date" class="form-control col-2" name="fechComp" id="fechComp" value="<?=$compra['fechComp']?>">
        </div>
        <div class="form-group row">
            <label class="col-form-label col-2 text-right"  for="fechVenc"><strong>Fecha de vencimiento</strong></label>
            <input type="date" class="form-control col-2" name="fechVenc" id="fechVenc" value="<?=$compra['fechVenc']?>">
        </div>
        <div class="form-group row">
