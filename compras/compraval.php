...
<html lang="es">
<head>
    <title>Compra de Tapas y V�lvulas</title>
...
<tr>
    ...
    <tr>
   	  <td colspan="2"><div align="center" class="titulo"><strong>INGRESO DE COMPRA DE V�LVULAS Y TAPAS</strong></div></td>
    </tr>
    <tr>
      <td width="44%">&nbsp;</td>
      <td width="56%">&nbsp;</td>
    ...
    <tr>
      <td><strong>N�mero de Factura</strong></td>
