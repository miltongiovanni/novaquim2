...
<form method="post" action="detCompradist.php" name="form1">	
    ...
    <tr>
      ...
      <td><input type="text" name="FchFactura" id="sel2" readonly size=20><input type="reset" value=" ... "
		onclick="return showCalendar('sel2', '%Y-%m-%d', '12', true);"></td>
    </tr>
    <tr>
   	  <td ><div align="right"><strong>Fecha Vencimiento</strong></div></td>
        <td><input type="text" name="VenFactura" id="sel1"  readonly size=20><input type="reset" value=" ... "
