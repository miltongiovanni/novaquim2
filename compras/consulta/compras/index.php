...
<html lang="es">
<head>
    <title>Consulta de Compras por Fecha</title>
    <meta charset="utf-8">
...
<div id="contenedor" class="container-fluid">
    <div id="saludo">
        <img src="../../../images/LogoNova1.jpg" alt="novaquim" class="img-fluid mb-2 w-25"><h4>CONSULTA DE COMPRA POR FECHA</h4></div>
    <form method="post" action="listarConsCompras.php" name="form1">
        <div class="mb-3 row">
            <div class="col-2">
