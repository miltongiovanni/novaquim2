...
<div id="contenedor">
    ...
    <form name="form2" method="POST" action="updateGasto.php">
        <div class="form-group row">
            ...
            <input type="text" class="form-control col-2" name="idGasto" id="idGasto" value="<?= $gasto['idGasto'] ?>"
                   readonly>
        </div>
        <div class="form-group row">
        ...
        <div class="form-group row">
            ...
            <input type="text" class="form-control col-2" name="numFact" id="numFact" value="<?= $gasto['numFact'] ?>"
