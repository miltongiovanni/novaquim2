...
<html>
<head>
    <title>Consulta de Gastos por Fecha</title>
    <meta charset="utf-8">
...
<body> 
<div id="contenedor">
<div id="saludo"><strong>CONSULTA DE GASTOS POR FECHA</strong></div>
<form method="post" action="listarConsGastos.php" name="form1">	
<table align="center">
     <tr>
      <td width="101" align="right"><strong>Fecha Inicial</strong></td>
      <td width="200"><input type="text" name="FchIni" id="sel1" readonly size=20><input type="reset" value=" ... "
