...
<body>
<div id="contenedor">
<div id="saludo"><strong>SELECCIONAR PROVEEDOR DE COMPRAS A CONSULTAR ESTADO DE PAGOS</strong></div>

<table width="100%" border="0">
  	<tr>
    	<td>
		<form id="form1" name="form1" method="post" action="pagosXcomprasProv.php">
