...
<form action="updatePedVD.php" method="post" name="actualiza">
<table width="55%" border="0" align="center" summary="cuerpo">
  ...
  <?php
	...
	else
	{
		...
		$qry="SELECT Cod_producto as Codigo, Producto, Can_producto as Cantidad, Prec_producto as Precio from det_pedido, herramientas 
		where Cod_producto=Id_herramienta and Id_ped=$pedido AND Cod_producto=$producto;";
