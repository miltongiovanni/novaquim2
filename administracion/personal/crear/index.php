...
<div id="contenedor" class="container-fluid">
    ...
    <form name="form2" method="POST" action="makePerson.php">
        ...
        <div class="form-group row">
            <label class="col-form-label col-1 text-end" for="emlPersonal"><strong>E-mail</strong></label>
            <input type="email" class="form-control col-2" id="emlPersonal" name="emlPersonal" size=30>
        </div>
        <div class="form-group row">
            <label class="col-form-label col-1 text-end" for="activoPersonal"><strong>Estado</strong></label>
        ...
        <div class="form-group row">
            <label class="col-form-label col-1 text-end" for="areaPersonal"><strong>Área</strong></label>
        ...
        <div class="form-group row">
            <label class="col-form-label col-1 text-end" for="cargoPersonal"><strong>Cargo</strong></label>
