...
include "includes/utilTabla.php";
	...
	where Codigo=$IdMP AND det_compras.Id_compra=compras.Id_compra AND Codigo=Cod_mprima AND compra= 1 and Cod_iva=Id_tasa AND nit_prov=NIT_provee ORDER BY Fech_comp DESC; ";
