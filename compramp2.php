...
<html>
<head>
    <title>Ingreso de la Compra de Materia Prima</title>
    <meta charset="utf-8">
...
<body> 
<div id="contenedor">
<div id="saludo"><strong>INGRESO DE COMPRA DE MATERIAS PRIMAS</strong></div>
<?php
...
<form method="post" action="detCompramp.php" name="form1">	
  	<table align="center" summary="seleccion">
    <tr>
    ...
    <tr><td align="right"><strong>Proveedor</strong></td>
      <td><?php
			include "includes/conect.php";
			$link=conectarServidor();
			echo'<select name="nit_prov">';
			$result=mysqli_query($link,"select NIT_provee, Nom_provee from proveedores where Id_cat_prov=1 order by Nom_provee");
			$result1=mysqli_query($link,"select NIT_provee, Nom_provee, Num_fact, Fech_comp, Fech_venc from proveedores, compras where Id_cat_prov=1 and Id_compra=$Factura and NIT_provee=nit_prov;");
    ...
    <tr>
      ...
      <td><input type="text" name="FchFactura" id="sel2" readonly size=36 value="<?php echo $row1['Fech_comp']; ?>"><input type="reset" value=" ... "
		onclick="return showCalendar('sel2', '%Y-%m-%d', '12', true);"></td>
    </tr>
    <tr>
   	  <td align="right" ><strong>Fecha Vencimiento</strong></td>
        <td><input type="text" name="VenFactura" id="sel1"  readonly size=36 value="<?php echo $row1['Fech_venc']; ?>"><input type="reset" value=" ... "
