...
<div id="contenedor" class="container-fluid">
    <div id="saludo">
        ...
        <h4>RELACIÓN MATERIA PRIMA CON PRODUCTO DE DISTRIBUCIÓN</h4>
    </div>
    <form name="form2" method="POST" action="make_env_dist.php">

        <div class="mb-3 row">
            <div class="col-2">
                <label class="form-label" for="codMPrimaDist"><strong>Materia Prima</strong></label>
                <select name="codMPrimaDist" id="codMPrimaDist" class="form-select" style="margin: 0 5px 0 0;"
                        required>
            ...
            <div class="col-2">
                ...
                $filas = count($medidas);
                echo '<select name="codMedida" id="codMedida" class="form-select" required>';
            ...
            <div class="col-2">
                ...
                $filas = count($tapas);
                echo '<select name="codTapa" id="codTapa" class="form-select" required>';
                echo '<option selected value="">Seleccione una opción</option>';
                for ($i = 0; $i < $filas; $i++) {
