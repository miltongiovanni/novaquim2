...
$pdf->SetFont('Arial', 'B', 11);
$pdf->Cell(65, 8, utf8_decode('CÓDIGO: DP-OEE-01'), 1, 0, 'C');
$pdf->SetXY(60, 18);
$pdf->SetFont('Arial', 'B', 11);
$pdf->Cell(80, 16, utf8_decode('ORDEN DE ENVASADO Y ETIQUETADO'), 1, 0, 'C');
$pdf->SetFont('Arial', 'B', 11);
...
$pdf->Cell(95, 8, utf8_decode('DEPARTAMENTO DE PRODUCCIÓN'), 1, 0, 'C');
$pdf->SetFont('Arial', 'B', 11);
$pdf->Cell(55, 8, utf8_decode('CÓDIGO: DP-CPT-01'), 1, 0, 'C');
$pdf->SetXY(55, 163);
$pdf->SetFont('Arial', 'B', 11);
$pdf->Cell(95, 16, utf8_decode('CONTROL DE CALIDAD PRODUCTO TERMINADO'), 1, 0, 'C');
$pdf->SetFont('Arial', 'B', 11);
$pdf->Cell(55, 8, utf8_decode('VERSIÓN: 1.00') , 1, 0, 'C');
$encabfecha = date('Y-m-d');
date_default_timezone_set('America/Bogota');
$pdf->SetXY(150, 171);
$pdf->Cell(55, 8, utf8_decode('Fecha emisión: ') . $encabfecha, 1, 0, 'C');
$pdf->SetXY(10, 183);
$pdf->SetFont('Arial', 'B', 10);
