...
<table width="34%" border="0" align="center" summary="cuerpo">
  ...
  <?php
	...
	$qry="SELECT det_formula_mp.Cod_mprima as codigo, Nom_mprima, porcentaje FROM det_formula_mp, mprimas where Id_formula_mp=$IdForm AND det_formula_mp.Cod_mprima=mprimas.Cod_mprima AND det_formula_mp.Cod_mprima=$mprima;";
