...
<table border="0" align="center">
  ...
  <?php
	...
	$qry="SELECT Lote, codPresentacion as Codigo, Nombre AS Presentacion, Can_prese as Cantidad 
	FROM envasado, prodpre
	WHERE codPresentacion=Cod_prese and Lote=$Lote and codPresentacion=$cod_pres;";
	echo $qry;
