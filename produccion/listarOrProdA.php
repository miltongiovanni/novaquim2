...
<html>
<head>
<title>Lista de &Oacute;rdenes de Producci&oacute;n Anuladas</title>
<meta charset="utf-8">
...
<body>
<div id="contenedor">
<div id="saludo1"><strong>LISTA DE &Oacute;RDENES DE PRODUCCI&Oacute;N ANULADAS</strong></div>
...
<table border="0" align="center" cellspacing="0" summary="cuerpo">
	<tr>
      ...
      <th width="330" class="formatoEncabezados">Producto</th>
      <th width="254" class="formatoEncabezados">F&oacute;rmula</th>
...
Nom_form as 'Formulación', Cant_kg as 'Cantidad (Kg)', nom_personal as Responsable
FROM ord_prod, formula, productos, personal
WHERE ord_prod.Id_form=formula.Id_form AND formula.Cod_prod=productos.Cod_produc and Cod_persona=Id_personal and Estado='A'
order by Lote desc;";
