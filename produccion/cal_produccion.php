...
<table width="40%" border="0" align="center">
 <tr>
   ...
   <tr>
    ...
    <td width="27%"><div align="center"><input type="text" name="pH" size=8 onKeyPress="return aceptaNum(event)" ></div></td>
  </tr>
   <tr>
    ...
    <td width="27%"><div align="center"><input type="text" name="den_prod" size=8 onKeyPress="return aceptaNum(event)" ></div></td>
  </tr>
  <tr>
    <td width="17%"><div align="center"><strong>Olor</strong></div></td>
    <td colspan="2"><div align="center"><?php echo $roword['Fragancia']; ?></div></td>
    <td width="27%"><div align="center"><select name="ol_prod"> <option value="0" selected>SI</option><option value="1">NO</option></select></div></td>
  </tr>
  <tr>
    <td width="17%"><div align="center"><strong>Color</strong></div></td>
    <td colspan="2"><div align="center"><?php echo $roword['Color']; ?></div></td>
    <td width="27%"><div align="center"><select name="col_prod"> <option value="0" selected>SI</option><option value="1">NO</option></select></div></td>
  </tr>
  <tr>
    ...
    <td width="27%"><div align="center"><select name="ap_prod"> <option value="0" selected>SI</option><option value="1">NO</option></select></div></td>
  </tr>
    <tr>
    <td width="17%"><div align="center"><strong>Observaciones</strong></div></td>
    <td colspan="3"><div align="center"><input type="text" name="obs_prod" size=55 value=" "></div></td>
  </tr>
<tr>
