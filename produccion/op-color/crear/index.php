...
<div id="contenedor" class="container-fluid">
    ...
    <form method="post" action="makeO_Prod_col.php" name="form1">
        <div class="mb-3 row">
            <div class="col-2">
                <label class="form-label" for="idFormulaColor"><strong>Solución de color</strong></label>
                <?php
                $FormulaColorOperador = new FormulasColorOperaciones();
                $formulas = $FormulaColorOperador->getFormulasColor();
                $filas = count($formulas);
                echo '<select name="idFormulaColor" id="idFormulaColor" class="form-select" required>';
