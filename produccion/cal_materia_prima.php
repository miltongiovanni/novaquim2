...
<div id="contenedor" class="container-fluid">
    ...
    <form id="cal_m_prima_form" method="POST" action="makeCalMatPrima.php">
        ...
        <div class="mb-3 row">
            <label for="lote_mp" class="col-2 text-center form-label px-2l"><strong>Lote</strong></label>
            <div class="col-2 bg-blue text-center form-label pe-2"><?= $calidadMPrima['lote_mp'] ?></div>
        ...
        <div class="mb-3 row">
            ...
            <div class="col-2 bg-blue text-center form-label pe-2"><?= $calidadMPrima['cantidad'] ?></div>
            <div class="col-1 ps-2">
        ...
        <div class="mb-3 row <?= empty($calidadMPrima['olorMPrima']) ? 'd-none' : '' ?>">
            <label for="olor_mp" class="col-2 text-center form-label px-2"><strong>Olor</strong></label>
