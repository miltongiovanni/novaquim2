...
<tr>
	<td colspan="2" align="left" class="titulo">Especificaci�n</td>
</tr>
<tr>
...
<tr>
	<td width="47%" align="right"><strong>Gravedad Espec�fica:</strong></td>
...
<form id="form1" name="form1" method="post" action="controlMP.php">
    ...
    <tr>
	<td align="left" class="titulo">Resultados An�lisis</td>
...
<tr>
	<td width="48%" align="right"><strong>Gravedad Espec�fica:</strong></td>
	<td width="38%">
