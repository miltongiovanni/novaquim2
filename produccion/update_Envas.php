...
<?php
	...
	if($cantidad >= $cantidad_ant)
	{
		...
		$qry_env="select * from inv_envase where Cod_envase = (select Cod_envase from prodpre where Cod_prese=$cod_pres)";
		...
		$qry_val="select * from inv_tapas_val where Cod_tapa = (select Cod_tapa from prodpre where Cod_prese=$cod_pres)";
		...
		$qry_etq="select * from inv_etiquetas where Cod_etiq = (select Cod_etiq from prodpre where Cod_prese=$cod_pres)";
