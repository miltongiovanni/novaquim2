    ...
    <tr>
      ...
      <td width="351">
      	<div align="left"> <?php
				...
				$result=mysqli_query($link,"SELECT Id_kit as Id, Codigo as Código, Nombre as Producto, Nom_envase as Envase from kit, prodpre, envase where Codigo=Cod_prese AND Cod_env=envase.Cod_envase
		union
