...
function menu(F,I)
{
	...
	this.onmouseover=W;
	this.onmousedown=U;
	this.J={'block_top':16,'block_left':16,'top':20,'left':4,'width':500,'height':22,'hide_delay':0,'expd_delay':0,'css':{'inner':'','outer':''}};
