...
function menu(F,I)
{
	...
	this.onmouseover=W;
	this.onmousedown=U;
	this.J={'block_top':1,'block_left':5,'top':4,'left':4,'width':12,'height':4,'hide_delay':0,'expd_delay':0,'css':{'inner':'','outer':''}};
