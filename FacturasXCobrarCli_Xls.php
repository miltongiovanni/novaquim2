...
$sql="	select Factura, Nom_clien as Cliente, Contacto, Cargo, Tel_clien as Teléfono, Cel_clien as Celular, Fech_fact as 'Fecha Factura', Fech_venc as 'Fecha Vmto', Total , Subtotal, IVA from factura, clientes WHERE Nit_cliente=Nit_clien and factura.Estado='P' and Nit_cliente='$cliente';";
