...
<div class="container-fluid">
    ...
    <div class="my-4 row">
        <div class="col-5"><button class="button" type="button" onClick="window.location='../compras/tesoreria/facturas-por-pagar/index.php'"><span>Ir a pagar facturas</span></button></div>
    </div>
</div>
