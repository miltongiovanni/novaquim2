...
<head>
    <meta charset="utf-8">
    <title>Seleccionar Producto de Distribución a desactivar</title>
...
<div id="contenedor" class="container-fluid">
    <div id="saludo">
        <img src="../../../images/LogoNova1.jpg" alt="novaquim" class="img-fluid mb-2 w-25"><h4>PRODUCTO DE DISTRIBUCIÓN A DESACTIVAR</h4></div>
    <?php
