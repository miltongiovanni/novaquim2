...
<body>
    <div id="contenedor" class="container-fluid">
        <div id="saludo">
        <img src="../../../images/LogoNova1.jpg" alt="novaquim" class="img-fluid mb-2 w-25"><h4>SELECCIONAR PRESENTACIÓN DE PRODUCTO A ACTIVAR</h4></div>
        <?php
        include "../../../includes/base.php";
        $rep = buscarPresentacionForm("activ_prese.php", false);
        echo $rep;
        ?>
