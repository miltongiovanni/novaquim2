    ...
    <div id="contenedor">
        ...
        <form name="form2" method="POST" action="makeMP.php">
            ...
            <div class="form-group row">
                ...
                <input type="text" class="form-control col-2" name="aparienciaMPrima" id="aparienciaMPrima" onKeyPress="return aceptaLetra(event)" required>
            ...
            <div class="form-group row">
                ...
                <input type="text" class="form-control col-2" name="minStockMprima" id="minStockMprima" onKeyPress="return aceptaNum(event)" required>
            </div>
            <div class="form-group row">
                <label class="col-form-label col-1 text-right"  for="pHmPrima"><strong>pH</strong></label>
                <input type="text" class="form-control col-2" name="pHmPrima" id="pHmPrima" placeholder="Si no tiene escribir N.A." required>
                <label class="col-form-label col-1 text-right"  for="densidadMPrima"><strong>Densidad</strong></label>
                <input type="text" class="form-control col-2" name="densidadMPrima" id="densidadMPrima" placeholder="Si no tiene escribir N.A." required>
            </div>

            <div class="form-group row">
                <label class="col-form-label col-1 text-right"  for="colorMPrima"><strong>Color</strong></label>
                <input type="text" class="form-control col-2" name="colorMPrima" id="colorMPrima" onKeyPress="return aceptaLetra(event)" maxlength="30" required>
                <label class="col-form-label col-1 text-right"  for="olorMPrima"><strong>Olor</strong></label>
                <input type="text" class="form-control col-2" name="olorMPrima" id="olorMPrima" onKeyPress="return aceptaLetra(event)" maxlength="30" required>
            </div>
