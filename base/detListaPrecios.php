...
if ($_POST['seleccion1']) {
    ...
    $precios1 = array();
    for ($k = 0; $k < $c; $k++) {
        if ($_POST['seleccion1'][$k] == 1) {$precios1[] = " Fábrica";
            $precios[] = " fabrica";}
        if ($_POST['seleccion1'][$k] == 2) {$precios1[] = " Distrib";
            $precios[] = " distribuidor";}
        if ($_POST['seleccion1'][$k] == 3) {$precios1[] = " Detal";
            $precios[] = " detal";}
        if ($_POST['seleccion1'][$k] == 4) {$precios1[] = " Mayor";
            $precios[] = " mayor";}
        if ($_POST['seleccion1'][$k] == 5) {$precios1[] = " Super";
            $precios[] = " super";}
    }
