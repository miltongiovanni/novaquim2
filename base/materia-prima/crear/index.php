    ...
    <form name="form2" method="POST" action="makeMP.php">
        <div class="form-group row">
            <div class="col-1 text-end">
                <label class="col-form-label " for="idCatMPrima"><strong>Categoría MP</strong></label>
            </div>
            ...
            echo '<div class="col-2 px-0"><select name="idCatMPrima" id="idCatMPrima" class="form-control " onchange="codigoMP(this.value)"  required>';
            ...
            ?>
            <div class="col-1 text-end">
                <label class="col-form-label " for="codMPrima"><strong>Código</strong></label>
            </div>
            <div class="col-2 px-0">
                <input type="text" class="form-control " name="codMPrima" id="codMPrima" readOnly>
            </div>
            <div class="col-1 text-end">
                <label class="col-form-label " for="aliasMPrima"><strong>Alias M Prima</strong></label>
            </div>
            <div class="col-2 px-0">
        ...
        <div class="form-group row">
            <div class="col-1 text-end">
                <label class="col-form-label " for="nomMPrima"><strong>Materia Prima</strong></label>
            </div>
            <div class="col-2 px-0">
                <input type="text" class="form-control " name="nomMPrima" id="nomMPrima" required>
            </div>
            <div class="col-1 text-end">
                <label class="col-form-label " for="aparienciaMPrima"><strong>Apariencia</strong></label>
            </div>
            <div class="col-2 px-0">
        ...
        <div class="form-group row">
            ...
            $filas = count($tasas);
            echo '<div class="col-2 px-0"><select name="codIva" id="codIva" class="form-control "  required>';
            echo '<option selected disabled value="">-----------------------------</option>';
            for ($i = 0; $i < $filas; $i++) {
            ...
            ?>
            <div class="col-1 text-end">
                <label class="col-form-label " for="minStockMprima"><strong>Stock Min</strong></label>
            </div>
            <div class="col-2 px-0">
        ...
        <div class="form-group row">
            <div class="col-1 text-end">
                <label class="col-form-label " for="pHmPrima"><strong>pH</strong></label>
            </div>
            <div class="col-2 px-0">
            ...
            <div class="col-1 text-end">
                <label class="col-form-label " for="densidadMPrima"><strong>Densidad</strong></label>
            </div>
            <div class="col-2 px-0">
        ...
        <div class="form-group row">
            <div class="col-1 text-end">
                <label class="col-form-label " for="colorMPrima"><strong>Color</strong></label>
            </div>
            <div class="col-2 px-0">
            ...
            <div class="col-1 text-end">
                <label class="col-form-label " for="olorMPrima"><strong>Olor</strong></label>
            </div>
            <div class="col-2 px-0">
