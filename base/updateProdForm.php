...
<body>
  <div id="contenedor">
    ...
    <div class="form-group row">
                ...
                <input type="hidden" class="form-control col-2" name="idCatProd" id="idCatProd"  value="<?=$producto['idCatProd'];?>">
                <input type="text" class="form-control col-2" name="catProd" id="catProd"  value="<?=$producto['catProd'];?>" readOnly>
                <label class="col-form-label col-1" style="text-align: right;" for="codProducto"><strong>Código</strong></label>
                <input type="text" class="form-control col-2" name="codProducto" id="codProducto" value="<?=$producto['codProducto'];?>" readOnly>
            </div>
            <div class="form-group row">
                <label class="col-form-label col-1" style="text-align: right;" for="nomProducto"><strong>Producto</strong></label>
                <input type="text" class="form-control col-2" name="nomProducto" id="nomProducto" onKeyPress="return aceptaLetra(event)" maxlength="50" value="<?=$producto['nomProducto'];?>">
                <label class="col-form-label col-1" style="text-align: right;" for="apariencia"><strong>Apariencia</strong></label>
                <input type="text" class="form-control col-2" name="apariencia" id="apariencia" onKeyPress="return aceptaLetra(event)" value="<?=$producto['apariencia'];?>">
            </div>
            <div class="form-group row">
                <label class="col-form-label col-1" style="text-align: right;" for="densMin"><strong>Densidad Min</strong></label>
                <input type="text" class="form-control col-2" name="densMin" id="densMin" onKeyPress="return aceptaNum(event)" value="<?=$producto['densMin'];?>">
                <label class="col-form-label col-1" style="text-align: right;" for="densMax"><strong>Densidad Max</strong></label>
                <input type="text" class="form-control col-2" name="densMax" id="densMax" onKeyPress="return aceptaNum(event)" value="<?=$producto['densMax'];?>">
            </div>

            <div class="form-group row">
                <label class="col-form-label col-1" style="text-align: right;" for="pHmin"><strong>pH Min</strong></label>
                <input type="text" class="form-control col-2" name="pHmin" id="pHmin" onKeyPress="return aceptaNum(event)" value="<?=$producto['pHmin'];?>">
                <label class="col-form-label col-1" style="text-align: right;" for="pHmax"><strong>pH Max</strong></label>
                <input type="text" class="form-control col-2" name="pHmax" id="pHmax" onKeyPress="return aceptaNum(event)" value="<?=$producto['pHmax'];?>">
            </div>

            <div class="form-group row">
                <label class="col-form-label col-1" style="text-align: right;" for="fragancia"><strong>Fragancia</strong></label>
                <input type="text" class="form-control col-2" name="fragancia" id="fragancia" onKeyPress="return aceptaLetra(event)" maxlength="30" value="<?=$producto['fragancia'];?>">
