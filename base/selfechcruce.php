...
<html lang="es">
<head>
    <title>Cruce productos distribución por mes</title>
    <meta charset="utf-8">
...
<body> 
<div id="contenedor">
<div id="saludo"><strong>CRUCE PRODUCTOS DISTRIBUCIÓN POR MES</strong></div>
<form method="post" action="cruce_dist_mes.php" name="form1">	
	<table align="center">
    <tr>
      	<td>&nbsp;</td>
      	<td>&nbsp;</td>
