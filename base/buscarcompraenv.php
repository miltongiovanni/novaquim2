...
<form id="form1" name="form1" method="post" action="compraenv2.php">	
<table border="0" align="center">
    <tr> 
        <td><div align="right"><strong>No. de Compra&nbsp;</strong></div></td>
        <td><input type="text" name="Factura" size=10 onKeyPress="return aceptaNum(event)"></td><input type="hidden" name="CrearFactura" value="5">
    </tr>
    <tr>
