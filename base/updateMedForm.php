...
<body>
	<div id="contenedor">
		<div id="saludo"><strong>ACTUALIZACIÓN DE PRESENTACIONES DE PRODUCTO</strong></div>
		<form id="form1" name="form1" method="post" action="updateMed.php">
			<div class="form-group row">
				...
				<input type="text" name="codPresentacion" id="codPresentacion" class="form-control col-2" onKeyPress="return aceptaNum(event)" value="<?= $codPresentacion ?>" readonly />

				<label class="col-form-label col-2" for="presentacion"><strong>Presentación</strong></label>
				<input name="presentacion" id="presentacion" class="form-control col-3" type="text" value="<?= $presentacion['presentacion'] ?>" />
			...
			<div class="form-group row">
				...
				<input name="stockPresentacion" id="stockPresentacion" type="text" value="<?=$presentacion['stockPresentacion'] ?>" class="form-control col-2" onKeyPress="return aceptaNum(event)" />
