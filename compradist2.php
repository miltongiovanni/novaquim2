...
<html>
<head>
    <title>Compra de Productos de Distribuci&oacute;n</title>
    <meta charset="utf-8">
...
<body>
<div id="contenedor">
<div id="saludo"><strong>INGRESO  COMPRA DE PRODUCTOS DE DISTRIBUCI&Oacute;N</strong></div> 
<?php
...
<form method="post" action="detCompradist.php" name="form1">	
    ...
    <tr>
      ...
      <td><?php
			...
			$result=mysqli_query($link,"select * from proveedores where Id_cat_prov=5 order by Nom_provee");
			$result1=mysqli_query($link,"select NIT_provee, Nom_provee, Num_fact, Fech_comp, Fech_venc from proveedores, compras where Id_cat_prov=5 and Id_compra=$Factura and NIT_provee=nit_prov;");
